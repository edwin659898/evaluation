                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="invoice p-3 mb-3">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table invoice-detail-table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-sm">{{$sectionTwo->comp->competence_skill}}</td>
                                                                            <td><input type="text" disabled value="{{$sectionTwo->Employee_level}}" class="mike average text-sm border-white" /></td>
                                                                            <td><input type="text" disabled value="{{$sectionTwo->Supervisor_level}}" class="txt average text-sm border-white" /></td>
                                                                            <td><span class="text-sm">{{$sectionTwo->Comments}}</span></td>
                                                                        </tr>
                                                                        @endforeach
                                                                        <tr>
                                                    ...
                                                    <div class="border-double border-4 border-light-blue-500 rounded-md mt-2">
                                                        ...
                                                        <form action="{{route('manager.comment',$data->sectionSix->id)}}" method="POST">
                                                            @csrf
                                                            @method('patch')
                                                            <div class="row px-4 pt-2">
                                                                <div class="form-group w-full">
                                                                ...
                                                                <div class="form-group w-full">
                                                                    ...
                                                                    <textarea name="manager_comments" class="summernote">{{$data->sectionSix->manager_comments ?? ''}}{{ old('hod_comments') }}</textarea>
                                                                </div>
                                                            </div>
