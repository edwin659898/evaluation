    ...
    <div class="relative">
        <div class="flex justify-between items-center mb-1">
            <div class="h-10 flex items-center">
                ...
                <div class="w-96 flex rounded-lg shadow-sm mt-2 mb-3">
            ...
            <div class="flex flex-wrap items-center space-x-1">
                ...
                <div x-data="{ init() {
                    ...
                    <button wire:click="export" class="flex items-center space-x-2 px-3 border border-green-400 rounded-md text-white bg-green-700 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-green-500 focus:outline-none"><span>{{ __('Export') }}</span>
        ...
        <div wire:loading.class="opacity-50" class="rounded-lg @unless($complex || $this->hidePagination) rounded-b-none @endunless shadow-lg bg-white max-w-screen overflow-x-scroll border-4 @if($complex) rounded-b-none border-b-0 @endif">
            <div>
        ...
        @unless($this->hidePagination)
            <div class="max-w-screen bg-white @unless($complex) rounded-b-lg @endunless border-4 border-t-0 border-b-0">
