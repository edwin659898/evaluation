<x-app-layout>
    ...
    <div class="content">
        <div class="container">
            ...
            <!-- /.row -->
            <div class="row">
                <div class="evaluation flex justify-center items-center" id="evaluation">
                    <div>
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text.
                            ...
                            The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. S
                            ections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in
