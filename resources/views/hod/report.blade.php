                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="invoice p-3 mb-3">
                                                    ...
                                                    <div class="border-double border-4 border-light-blue-500 rounded-md mt-2">
                                                        ...
                                                        <form action="{{route('hod.comment',$data->sectionSix->id)}}" method="POST">
                                                            @csrf
                                                            @method('patch')
                                                            <div class="row px-4 pt-2">
                                                                <div class="form-group w-full">
                                                                ...
                                                                <div class="form-group w-full">
                                                                    ...
                                                                    <textarea name="hod_comments" class="summernote">{{$data->sectionSix->hod_comments ?? ''}}{{ old('hod_comments') }}</textarea>
                                                                </div>
                                                            </div>
